...
class SublayerConnection(nn.Module):
    ...
    def forward(self, x, sublayer):
        ...
        #Post-LN
        # return self.dropout(x+sublayer(self.norm(x)))
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, memory, src_mask, tgt_mask):
        ...
        # 参照EncoderLayer完成DecoderLayer的forwark函数
...
def batch_greedy_decode(model, src, src_mask, max_len=64, start_symbol=1, end_symbol=2):
